...
async function connectionUpdate(update) {
  ...
  if (connection === 'open') {
    ...
    const msg = `*Hello there SAINT_ZENIN-MD User! 👋🏻*\n\n` +
                `> Simple , Straight Forward But Loaded With Features 🎊, Meet SAINT_ZENIN-MD WhatsApp Bot.\n\n` +
                `*Thanks for using SAINT_ZENIN-MD 🚩*\n\n` +
                `> Join WhatsApp Channel :- ⤵️\n\n` +
                `https://whatsapp.com/channel/0029VatOy2EAzNc2WcShQw1j\n\n` +
                `- YOUR PREFIX :* [ "` + prefix + `" ]\n\n` +
                `Dont forget to give star to repo ⬇️\n\n` +
                `https://github.com/LAWDTechXD/SAINT_ZENIN-MD\n\n` +
                `> © Powered BY LAWDTechX 🖤`
